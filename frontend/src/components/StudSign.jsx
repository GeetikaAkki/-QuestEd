    ...
    <div style={{ position: 'relative', overflow: 'hidden' }}>
      <div style={{ backgroundColor: '#FDF8EE', minHeight: '100vh', padding: '20px', position: 'relative' }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', maxWidth: '1200px', margin: '0 auto', width: '100%' }}>
          <div style={{ width: '50%' }}>
            ...
            {userType === 'Student' ? (
              <div>
                ...
                <p style={{ color: '#666' }}>
                  Create your account to explore personalized courses,<br />
              ...
              <div>
                ...
                <p style={{ color: '#666' }}>
                  Create your account to share resources, upload content,<br />
          ...
          <div style={{ width: '400px', backgroundColor: '#FF6B2B', borderRadius: '24px', padding: '32px' }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
              ...
              <div style={{ textAlign: 'center', marginTop: '16px', color: 'white' }}>
                ...
                <a href="/log-in" style={{ color: '#FDF8EE', textDecoration: 'underline' }}>
                  Log in
                </a>
              </div>
            </div>
